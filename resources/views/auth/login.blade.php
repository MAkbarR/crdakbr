...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('mdn/assets/assets/images/logos/favicon.png') }}" />
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="{{ route('login') }}" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="{{ asset('mdn/assets/images/logos/dark-logo.svg') }}" width="180" alt="">
                </a>
                ...
                <form action="{{ route('login-proses') }}" method="post">
                  ...
                  <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sing-in</button>
