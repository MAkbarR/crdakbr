                ...
                <div class="card-body">
                  <form action="{{ route('admins.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('fctr') is-invalid @enderror" name="fctr" value="{{ old('fctr') }}" placeholder="Masukkan Nama Prakirawan">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('k_hjn') is-invalid @enderror" name="k_hjn" value="{{ old('k_hjn') }}" placeholder="Masukkan Informasi Kondisi Hujan">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('angin') is-invalid @enderror" name="angin" value="{{ old('angin') }}" placeholder="Masukkan Informasi Angin Kencang">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('gel_tg') is-invalid @enderror" name="gel_tg" value="{{ old('gel_tg') }}" placeholder="Masukkan Informasi Gelommbang Tinggi">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('arus') is-invalid @enderror" name="arus" value="{{ old('arus') }}" placeholder="Masukkan Informasi Arus Kuat">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('arh_angin') is-invalid @enderror" name="arh_angin" value="{{ old('arh_angin') }}" placeholder="Masukkan Informasi Arah Angin">
                      @error('arh_angin')
                      <div class="alert alert-danger mt-2">
                          {{ $message }}
                      </div>
